      ...
      <div class="detail-col-main">
        <div class="card">
          ...
          <div class="chat-thread">
            ${messages.length
              ? messages.map((m) => messageBubble(m, user.id, request.id)).join('')
              : '<div class="chat-empty"><p class="muted mb-0">No messages yet. Say hello and outline what you need.</p></div>'}
          </div>
          ${canAct ? `
          <hr class="divider" />
